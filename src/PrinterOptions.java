 ...
 public static boolean feedPrinter(byte[] b)
        {
            try
            {
                ...
                AttributeSet attrSet = new HashPrintServiceAttributeSet(new PrinterName("EPSON TM-T20II Receipt5 LM", null)); //EPSON TM-U220 ReceiptE4


               // DocPrintJob job = PrintServiceLookup.lookupPrintServices(null, attrSet)[1].createPrintJob();
