 ...
 * @author Marko
 */
public final class EditReceipt extends javax.swing.JFrame {

    /**
     * Creates new form EditReceipt
     */
    EditReceiptClass nrc;
    String barNum, custID;
    Connection conn;
    ...
    public EditReceipt() {
        initComponents();
        nrc = new EditReceiptClass(this, cmbDept, cmbItem, tblItems, 0.0);
        updateLblTotal();
    }

    public EditReceipt(String barcode, String cID, double amount) throws SQLException {
        initComponents();
        nrc = new EditReceiptClass(this, cmbDept, cmbItem, tblItems, amount);
        barNum = barcode;
        custID = cID;
        populateUI();
        updateLblTotal();
    ...
    public void populateUI() throws SQLException {
        ...
        rs = pst.executeQuery();
        while (rs.next()) {
            lblID.setText(rs.getString("custID"));
            txtName.setText(rs.getString("custName"));
            txtSurname.setText(rs.getString("custSurname"));
            txtContact.setText(rs.getString("custContact"));
            txtEmail.setText(rs.getString("custEmail"));
            txtAddress1.setText(rs.getString("custAddress1"));
            txtAddress2.setText(rs.getString("custAddress2"));
            txtAddress3.setText(rs.getString("custAddress3"));
        }

        sql = "Select receiptID from tblReceipt where barcodeNumber = '" + barNum + "'";
        pst = conn.prepareStatement(sql);
        rs = pst.executeQuery();
        rs.next();
        ...
        sql = "Select * from tblReceiptItems where receiptID = '" + receiptID + "'";
        pst = conn.prepareStatement(sql);
        rs = pst.executeQuery();
        while (rs.next()) {
            ...
            nrc.addItemToTable(rs.getString("receiptItemQty"), rs.getString("receiptItemDesc"), rs.getString("receiptItemDept"),
                    rs.getString("receiptItemType"),
                    rs.getString("receiptItemUnitP"),
                    rs.getString("receiptItemTotalP"),
                    rs.getString("receiptItemNotes")
            );
//
//            while (rs.next()) {
//                
//                nrc.addItemToTable(rs.getString("receiptItemQty"), rs.getString(
//                        "receiptItemDesc"
//                ), rs.getString("receiptItemDept"),
//                        rs.getString("receiptItemType"),
//                        rs.getString("receiptItemUnitP"),
//                        rs.getString("receiptItemTotalP"),
//                        rs.getString("receiptItemNotes")
...
//            }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Void Selected Item");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditReceipt().setVisible(true);
            }
        });
    }
